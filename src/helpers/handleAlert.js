...
const messages = {
	...
	register_failed: { message: 'No hemos registrar tu usuario', type: 'error' },
	register_success: { message: 'Su usuario ha sido registrado exitosamente. Ya puede iniciar sesión', type: 'success' },
}
